...
//    修改渠道号
    ...
    public void swipeAddress(AndroidDriver driver) {
        ...
        TouchAction action1 = new TouchAction(driver).press(280, 1050).waitAction(duration).moveTo(280, 790).release();
        action1.perform();
...
/* 公共
   ...
   /* 公共
   public void clickConformAndRegister() {
        log.info("点击 确认并注册");
        btn_register.click();
    }*/
    public void clickInputSex() {
        layout_input_sex.click();
    }
    public void clickSelectNv() {
        log.info("点击 女性");
        select_nv.click();
    }
...
//    点击一键注册
    ...
    public void clickSayHelloLayout() {
        log.info("点击 给他们打招呼");
        say_hello_layout.click();
    }

    public void clickMsgManagerOk() {
        log.info("点击 开启招呼管家");
   ...
   /* //    附近模块
    ...
    public void clickIVCardUserName() {
        log.info("点击热聊-用户昵称");
        iv_card_user_name.click();
    }
    public String getIVCardUserName() {
        log.info("获取热聊-用户昵称");
        return iv_card_user_name.getText();
    }
    ...
    public String getTVCardAddress() {
        log.info("获取热聊上的用户地址");
        return tv_area.getText();
    }



    public void clickTVSayHello() {
        log.info("点击遇见页上打招呼按钮");
...
//
    ...
    public void clickMsgIconType() {
        log.info("点击“立即查看”");
        iv_msg_icon_type.get(0).click();
    }
...
*/
    ...
    public void clickItemQa() {
        log.info("点击匹配问答");
        body_item_qa.click();
    }
    //问题标题
    public String getQuesdtionTitle() {
    ...
    public void matchClick(AndroidDriver driver) {
        log.info("点击匹配问答");
        TouchAction action1 = new TouchAction(driver).press(419, 949).release();
        action1.perform();
    }
...
//        int width = driver.manage().window().getSize().width;
    ...
    //开通会员
    public void clickKaiTong1(AndroidDriver driver) {
        log.info("对方空间页查看在线状态");
        TouchAction action = new TouchAction(driver);
        action.tap(400, 1480).perform();
    }
