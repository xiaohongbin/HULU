...
//  #  地址修改
    ...
    @CacheLookup
    protected WebElement num_down_province;
...
/* 公共   //    渠道号
    ...
    // #   切换性别
    @FindBy(id = "com.huizheng.lasq:id/layout_input_sex")
    public WebElement layout_input_sex;
    // #   切换性别女
    @FindBy(id = "com.huizheng.lasq:id/select_nv")
    public WebElement select_nv;
...
//  #  1线女 注册后附近打招呼
    ...
    @CacheLookup
    public WebElement verificationPhone;
    ...
    //  # 一线 热聊页昵称
    @FindBy(xpath = "//android.widget.RelativeLayout/android.widget.ListView/android.widget.LinearLayout[1]/android.widget.RelativeLayout/android.widget.RelativeLayout[1]/android.widget.TextView[1]")
    @CacheLookup
    public WebElement iv_card_user_name;

    //  # 一线 遇见页引导
    @FindBy(id = "com.huizheng.lasq:id/iv_right_click")
    @CacheLookup
    public WebElement iv_right_click;
    ...
    //  #  一线缘分页 打招呼按钮
    @FindBy(id = "com.huizheng.lasq:id/iv_card_btn")
    @CacheLookup
    ...
    //    空间页照片
    @FindBy(xpath = "//android.support.v7.widget.RecyclerView/android.widget.RelativeLayout[2]/android.widget.GridView/android.widget.RelativeLayout")
    @CacheLookup
...
//    @CacheLookup
    ...
    //    下方信箱上未读标记
    @FindBy(xpath = "//android.widget.LinearLayout/android.widget.FrameLayout[5]/android.widget.FrameLayout/android.widget.TextView")
//    @CacheLookup
    public WebElement mailbox_num;

    //    来自超级曝光 私信按钮
    @FindBy(id = "com.huizheng.lasq:id/iv_msg_icon_type")
    @CacheLookup
    public List<WebElement> iv_msg_icon_type;
...
/*公共//  #  会员中心按钮
    ...
    //  #  个人资料
    @FindBy(id = "com.huizheng.lasq:id/tv_a")
    @CacheLookup
    ...
    //    问题标题
    @FindBy(id = "com.huizheng.lasq:id/quesdtion_title")
    @CacheLookup
    ...
    //    我的匹配问答
    @FindBy(id = "com.huizheng.lasq:id/body_item_qa")
    @CacheLookup
    public WebElement body_item_qa;
...
//    @CacheLookup
    ...
    //    我的头像
    @FindBy(id = "com.huizheng.lasq:id/header_view")
    @CacheLookup
    ...
    //  我关注的人数量
    @FindBy(id = "com.huizheng.lasq:id/tv_followNum")
    @CacheLookup
...
/* 公共
    ///    3线 800语音豆
    @FindBy(xpath = "//android.view.View[@content-desc=\"800语音豆\"]")
    @CacheLookup
...
//    @CacheLookup
    ...
    //    立即付款
    @FindBy(xpath = "//android.widget.Button[@content-desc=\"立即付款\"]")
    @CacheLookup
    public WebElement fukuan;
    //    支付成功后 支付宝 返回按钮
    @FindBy(xpath = "//android.widget.Button[@content-desc=\"返回\"]")
    @CacheLookup
