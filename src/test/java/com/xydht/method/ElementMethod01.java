package com.xydht.method;

import com.aventstack.extentreports.ExtentTest;
import com.listener.ExtentTestNGITestListener;
import com.xydht.page.PageElement;

//public class ElementMethod01 extends ElementsMethod {//继承ElementsMethod，不可以
public class ElementMethod01 extends PageElement {
    ExtentTestNGITestListener el = new ExtentTestNGITestListener();
    ExtentTest log = el.getlog();
//    PageElement pe = new PageElement();//继承ElementsMethod
...
//        TouchAction action1 = new TouchAction(driver).press(250, 800).waitAction(duration).moveTo(250, 1200).release();
//        action1.perform();
//    }
//
//    //    修改测试环境方法
...
//        address.click();
//    }
//    public void selectProvinceUp(){
//        log.info("对象列表,点击向上箭头");
//        up.click();
//        up.click();
//        up.click();
//    }
//    public void selectProvinceDown(){
//        log.info("对象列表,点击向下箭头");
//        down.click();
//        down.click();
//        down.click();
//    }
...
//        log.info("点击修改测试环境页面 保存");
//        btn_test_save.click();
//    }
//    //登录页面-立即登录和注册页面-去登陆元素，共用同一方法
...
////        btn_login.click();
////    }
//    public void clickGoToReg(){
//        log.info("登录页面，点击 去注册 链接");
//        gotoreg.click();
//    }
//    //注册页面
//
...
//        btn_i_know.click();
//    }
//    public void clickSayHelloToAll() {
//        log.info("女用户注册成功后，结识附近新朋友页面，点击 给他们打招呼");
//        say_hello_layout.click();
//    }
//    public void clickAuthInformation() {
//        log.info("女用户注册成功后，身份认证页面，点击完善资料");
//        identity_auth_information.click();
//    }
//    public void clickAuthUpload() {
//        log.info("女用户注册成功后，身份认证页面，点击上传头像");
//        identity_auth_upload.click();
//    }
//    public void clickAuthPhone() {
//        log.info("女用户注册成功后，身份认证页面，点击验证手机号");
//        identity_auth_phone.click();
//    }
//    public int getImageRegmanNum(){
//        log.info("获取 三线女用户，注册过程，结识附近的新朋友页面，男用户数量");
//        return image_regman.size();
//    }
//    public void clickImageRegman(){
//        log.info("三线女用户注册过程，结识附近的新朋友页面，点击男用户头像，取消选中");
//        for(int i =1;i<image_regman.size();i++)
//        image_regman.get(i).click();
//    }
...
//     * 注册引导LBS地图页面方法
//     */
//    public void clickYindaoHead(){
//        log.info("注册引导LBS地图页，点击第一个女用户头像");
//        yindaoHead.click();
//    }
//
...
//        log.info("缘分广场模块,点击更多");
//        gengduo.click();
//    }
//    public void clickTabTuijianSan() {
//        log.info("三线缘分广场模块,点击 推荐 标签");
//        tab_tuijian.click();
//    }
//    public void clickTabYuyinSan() {
//        log.info("三线缘分广场模块,点击 语音 标签");
//        tab_yuyin.click();
//    }
//    public void clickTabFujinSan() {
//        log.info("三线缘分广场模块,点击 附近 标签");
//        tab_fujin.click();
//    }
//    public void clickTabZhengyouSan() {
//        log.info("三线缘分广场模块,点击 征友 标签");
//        tab_zhengyou.click();
//    }
//    public void clickTabFujinNv() {
//        log.info("女用户缘分广场模块,点击 征附近 标签");
//        tab_fujinNv.click();
//    }
//
//    public void clickTabTuijianYi() {
//        log.info("一线缘分广场模块,点击 推荐 标签");
//        tab_tuijian1.click();
//    }
//
//    public void clickTabFujinYi() {
//        log.info("一线缘分广场模块,点击 附近 标签");
//        tab_fujin1.click();
//    }
//    public void clickTabZhengyouYi() {
//        log.info("一线缘分广场模块,点击 征友 标签");
//        tab_zhengyou1.click();
//    }
//
//    public void clickYuanfen() {
//        log.info("缘分广场模块,点击寻找缘分");
//        yuanfen_phone_call.click();
//    }
//    public void clickMatchBack() {
//        log.info("寻找缘分页面,点击结束按钮");
//        tv_phone_match_back.click();
//    }
//    public void clickPhoneClose() {
//        log.info("有缘人电话接通页面，点击关闭按钮");
//        iv_phone_pay_close.click();
//    }
//    public void clickPhoneCall() {
//        log.info("有缘人电话接通页面，点击立即接通");
//        tv_phone_pay_call.click();
//    }
//    public void clickIVUser() {
//        log.info("点击左上角第一个用户头像");
//        iv_user.get(0).click();
//    }
//    public void clickIVUser2() {
//        log.info("点击右上角第二个用户头像");
//        iv_user.get(1).click();
//    }
//
//    public String getTVName() {
//        log.info("获取推荐页列表上的用户名");
...
//        log.info("点击推荐页上第一个打招呼按钮");
//        sayhello.get(0).click();
//    }
//    public void clickSayHello2() {
//        log.info("点击推荐页上第2个头像的打招呼按钮");
//        sayhello.get(1).click();
//    }
//    public void clickSayHello3() {
//        log.info("点击推荐页上第3个头像的打招呼按钮");
//        sayhello.get(2).click();
//    }
//    public void clickGuanzhu() {
//        log.info("点击推荐页上第一个关注按钮");
//        guanzhu.get(0).click();
//    }
//
//    //    空间页方法
...
//    }
//
//    public void clickCancle1() {
//        log.info("点击取消按钮");
//        cancel.click();
//    }
//    public void clickSecPic() {
//        log.info("语音女，照片列表点击第二个女用户解锁图片");
//        secpic.click();
//    }
//
//
...
//    }
//    public void clickDaCall() {
//        log.info("UI差异化，点击新版语音聊天按钮");
//        daCall.click();
//    }
...
//        log.info("获取 消息右上角 未读条数");
//        return Integer.parseInt(letter_num.getText());
//    }
//
//    public int getMailboxNum() {
//        log.info("获取 消息标签右上角 未读条数");
//        return Integer.parseInt(mailbox_num.getText());
//    }
//    public int getLetterNum1() {
//        log.info("获取 消息右上角 未读条数");
//        return Integer.parseInt(letter_num1.getText());
//    }
//
//    public int getMailboxNum1() {
//        log.info("获取 消息标签右上角 未读条数");
//        return Integer.parseInt(mailbox_num1.getText());
//    }
//
...
//        log.info("一线男附近的人或者女用户身边人列表，获取附近人姓名");
...
//        log.info("获取我关注的人姓名");
//        return user_nickname.get(1).getText();
//    }
//
...
//        int width = driver.manage().window().getSize().width;
//        int height = driver.manage().window().getSize().height;
//        TouchAction action1 = new TouchAction(driver).press(width /3,height* 3/4).waitAction(duration).moveTo(width / 3, height/4).release();
//        action1.perform();
//    }
//
...
//
//    //    注册引导 附近  第一个头像
//    public void clickHelloTips(){
//        log.info("UI差异化，注册引导附近地图，打招呼提示");
//        helloTips.click();
//    }
//    public void clickNearTouxiang(){
//        log.info("UI差异化，注册引导附近地图，点击头像");
//        nearTouxiang.click();
//    }
//    public void clickNearUnlike(){
//        log.info("注册引导LBS页面，女用户头像页点击不喜欢");
//        nearUnLike.click();
//    }
//    public void clickNearLike(){
//        log.info("注册引导LBS页面，女用户头像页点击喜欢");
//        nearLike.click();
//    }
//    public String getNearNickname(){
//        log.info("UI差异化，注册引导附近地图，获取头像昵称");
//        return nearNickname.getText();
//    }
//    public void clickNear7(){
//        log.info("点击附近页面，第7个女用户图片");
//        near7.click();
//    }
//
//    //    3线男 附近  第一个头像
//    public void clickNear(){
//        log.info("三线男 附近，点击女用户头像");
//        near.click();
//    }
//
...
//     * 等待元素出现
//     */
////    public boolean waitForAeAppear(AndroidElement androidElement, int timeOutInSeconds,AndroidDriver driver) {
////        try {
...
////        }
////    }
//    public boolean waitForAeAppear(WebElement webElement,AndroidDriver driver) throws Exception{
//        try {
//            log.info("等待元素出现");
...
//    }
//
//    public static boolean isPresentElement(WebDriver driver, By by)
//    {
//        try {
...
//
//
////    public void waitElements(AndroidDriver driver){
////        WebDriverWait wait = new WebDriverWait(driver, 60);
