...
//    地理位置
    ...
    //居住地选择，省，向上箭头按钮
    @FindBy(id = "com.huizheng.lasq:id/num_up_province")
    @CacheLookup
    public WebElement up;
    //    服务端环境---不同于其他底包
    @FindBy(id = "com.huizheng.lasq:id/tv_test_env")
    @CacheLookup
...
/*  公共  //    渠道号
    ...
    @FindBy(xpath = "//android.widget.RelativeLayout/com.huizheng.lasq:id/imageLayout/android.widget.ImageView[7]")
    @CacheLookup
    public WebElement jinru;
...
/* 公共
     ...
     */
    //地图悬浮女用户头像
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout[1]/android.widget.ImageView")
    public WebElement yindaoHead;
    //    头像弹框
...
*/
    ...
    //寻找缘分
    @FindBy(id = "com.huizheng.lasq:id/imageLayout")
    @CacheLookup
    public WebElement gengduo;
    @FindBy(id = "com.huizheng.lasq:id/rv_yuanfen_phone_call")
    @CacheLookup
    public WebElement yuanfen_phone_call;
    @FindBy(id = "com.huizheng.lasq:id/tv_phone_match_des")
    @CacheLookup
    public WebElement match_des;

    @FindBy(id = "com.huizheng.lasq:id/tv_phone_match_back")
    @CacheLookup
    public WebElement tv_phone_match_back;

    @FindBy(id = "com.huizheng.lasq:id/iv_phone_pay_close")
    @CacheLookup
    public WebElement iv_phone_pay_close;
    @FindBy(id = "com.huizheng.lasq:id/tv_phone_pay_call")
    @CacheLookup
    public WebElement tv_phone_pay_call;
    //手机验证页面元素
    @FindBy(id = "com.huizheng.lasq:id/ed_verif_phonecode")
    @CacheLookup
    public WebElement ed_verif_phonecode;
    @FindBy(id = "com.huizheng.lasq:id/btn_verif_submit")
    @CacheLookup
    public WebElement btn_verif_submit;
    //三线男缘分广场标签，推荐，语音，附近，征友条件
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.RelativeLayout[1]/android.widget.TextView")
    @CacheLookup
    public WebElement tab_tuijian;

    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.RelativeLayout[2]/android.widget.TextView")
    @CacheLookup
    public WebElement tab_yuyin;
//    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.RelativeLayout[3]/android.widget.TextView")
    @FindBy(xpath="//android.widget.RelativeLayout[3]/android.widget.TextView")
    @CacheLookup
    public WebElement tab_fujin;
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.TextView")
    @CacheLookup
    public WebElement tab_zhengyou;
    //三线女，缘分广场，附近
    @FindBy(xpath="//android.widget.RelativeLayout[2]/android.widget.TextView")
    @CacheLookup
    public WebElement tab_fujinNv;
    //一线男缘分广场标签，推荐，附近，征友条件
    ...
    @CacheLookup
    public WebElement tab_tuijian1;
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.RelativeLayout[2]/android.widget.TextView")
    @CacheLookup
    public WebElement tab_fujin1;
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.TextView")
    @CacheLookup
    public WebElement tab_zhengyou1;
...
//    public List<WebElement> tv_nickname;
    //    推荐页 打招呼按钮
    @FindBy(id = "com.huizheng.lasq:id/actionView")
    @CacheLookup
    public List<WebElement> sayhello;
    //关注
    @FindBy(id = "com.huizheng.lasq:id/attentionView")
    @CacheLookup
    public List<WebElement> guanzhu;
    //    空间页头像
...
//    空间页用户名
    ...
    //关注
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.RelativeLayout[1]/android.widget.TextView")
    @CacheLookup
    public WebElement attention;
    //    空间页打招呼
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.RelativeLayout[2]/android.widget.TextView")
    @CacheLookup
    ...
    //    视频
    @FindBy(id = "com.huizheng.lasq:id/videoThumbnail")
    @CacheLookup
    public WebElement video_view;
    @FindBy(id = "com.huizheng.lasq:id/video_view")
    @CacheLookup
    public WebElement video_view1;

   //完善资料提示
    @FindBy(id = "com.huizheng.lasq:id/age_dialog_title")
    @CacheLookup
    public WebElement wanshan;
    @FindBy(id = "com.huizheng.lasq:id/cancel")
    @CacheLookup
    public WebElement cancel;
    //语音tab，查看第二张图片
    @FindBy(xpath="/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.support.v7.widget.RecyclerView/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.GridView/android.widget.RelativeLayout[2]/android.widget.ImageView[1]")
    @CacheLookup
    public WebElement secpic;
    ...
    //UI差异化，3线 语音聊天
    @FindBy(id="com.huizheng.lasq:id/voiceAnimLayout")
    @CacheLookup
    public WebElement daCall;
    //    手机验证下方 跳过
    ...
    public WebElement mailbox_num1;
    //    私信上未读的标记
...
//    @FindBy(xpath="/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.HorizontalScrollView/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.TextView")
   @FindBy(xpath ="//android.widget.FrameLayout[3]/android.widget.TextView")
    @CacheLookup
    public WebElement lianxi;
    //一线，全部，标签
//    @FindBy(xpath="/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.HorizontalScrollView/android.widget.LinearLayout/android.widget.FrameLayout[2]/android.widget.TextView[1]")
    @FindBy(xpath="//android.widget.FrameLayout[2]/android.widget.TextView")
    public WebElement sixin;
//    @FindBy(xpath="/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.HorizontalScrollView/android.widget.LinearLayout/android.widget.FrameLayout[1]/android.widget.TextView")
    @FindBy(xpath = "//android.widget.FrameLayout[1]/android.widget.TextView")
    public WebElement tongzhi1;
...
//    @FindBy(xpath="//android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.HorizontalScrollView/android.widget.LinearLayout/android.widget.FrameLayout[1]/android.widget.TextView")
    @FindBy(xpath="//android.widget.FrameLayout[1]/android.widget.TextView")
    @CacheLookup
...
//    进入附近模块后，显示的用户头像
    ...
    //    附近头像
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout[1]/android.widget.ImageView")
//    @CacheLookup
...
//    我的标签
    @FindBy(id = "com.huizheng.lasq:id/im_my_tag")
    @CacheLookup
    public WebElement mytag;
    @FindBy(id = "com.huizheng.lasq:id/body_item_9")
    @CacheLookup
    public WebElement mytag1;
//    我的标签中匹配问答

    @FindBy(partialLinkText="通过匹配")
    @CacheLookup
...
//    @CacheLookup
    ...
    //    右上角设置按钮
    @FindBy(id = "com.huizheng.lasq:id/im_setting")
    @CacheLookup
    public WebElement setting;
    //  我关注的人
    @FindBy(id = "com.huizheng.lasq:id/new_thing_phone")
    @CacheLookup
    public WebElement conversationperson;
    @FindBy(id = "com.huizheng.lasq:id/body_item_5")
    @CacheLookup
    public WebElement conversationperson1;
    //  我关注的人数量
    ...
    @FindBy(id = "com.huizheng.lasq:id/search_list_item_user_nickname")
    @CacheLookup
    public List<WebElement> user_nickname;
...
//    身高
    ...
    @FindBy(id="com.huizheng.lasq:id/icon_social")
    @CacheLookup
    public WebElement integrity1;
    //    身份认证
...
//
    ...
    //  3线  注册引导 附近，
    // 5.6.0差异化UI元素,打招呼提示，头像

    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.ImageView[2]")
    @CacheLookup
    public WebElement helloTips;
    //头像
    @FindBy(id="com.huizheng.lasq:id/iv")
    @CacheLookup
    public WebElement nearTouxiang;
    //不喜欢按钮
    @FindBy(id="com.huizheng.lasq:id/iv_delete")
    @CacheLookup
    public WebElement nearUnLike;
    //喜欢按钮
    @FindBy(id="com.huizheng.lasq:id/iv_sayhello")
    @CacheLookup
    public WebElement nearLike;
    //用户昵称
    @FindBy(id="com.huizheng.lasq:id/tv_name")
    @CacheLookup
    public WebElement nearNickname;
    //用户年龄
    @FindBy(id="com.huizheng.lasq:id/tv_age")
    @CacheLookup
    public WebElement nearAge;
    //用户身高
    @FindBy(id="com.huizheng.lasq:id/tv_height")
    @CacheLookup
    public WebElement nearHeight;
    //用户距离
    @FindBy(id="com.huizheng.lasq:id/tv_distance")
    @CacheLookup
    public WebElement nearDistance;
    //附近title，com.huizheng.lasq:id/title_name，公共元素，title_name

    @FindBy(xpath = "//android.widget.RelativeLayout[7]/android.widget.ImageView")
    @CacheLookup
    public WebElement near7;

    //    3线 附近模块 附近女用户头像
//    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout[1]/android.widget.ImageView")
    @FindBy(xpath="//android.widget.RelativeLayout[6]/android.widget.ImageView")
    @CacheLookup
