...
*/
    ...
    //    男用户注册第一个页面完善资料 传照片
//    上方文案 上传真实头像
    @FindBy(id = "com.huizheng.lasq:id/introduce_myself_describe")
    @CacheLookup
    public WebElement introduce_myself_describe;
...
//    public WebElement btn_i_know;
    ...
    //    对对碰
    @FindBy(id = "com.huizheng.lasq:id/btn_super_say_hello")
    @CacheLookup
    public WebElement btn_super_say_hello;
...
////    私信完善资料 身高
//    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.RelativeLayout")
//    @CacheLookup
//    public WebElement mailheight;
...
/*  公共
    ...
    //  未上传照片时，提示信息
    @FindBy(id = "com.huizheng.lasq:id/no_image_hint")
    @CacheLookup
    public WebElement noimg;
    //    上方头像
    @FindBy(id = "com.huizheng.lasq:id/header_view")
    @CacheLookup
    public WebElement head_view;
    //    审核照片
    ...
    //    录制语音介绍按钮
    @FindBy(id = "com.huizheng.lasq:id/transcribe_record_button")
    @CacheLookup
    public WebElement transcribe_record_button;
    //    重新录制
...
//    @CacheLookup
    ...
    @CacheLookup
    public WebElement miguvip;
    //    订购咪咕vip
    @FindBy(xpath = "//android.view.View[@content-desc=\"订购咪咕约会吧VIP会员\"]")
    @CacheLookup
    public WebElement dinggoumiguvip;
    //    migu游戏会员
    @FindBy(xpath = "//android.view.View[@content-desc=\"进入咪咕游戏联合会员专区\"]")
    @CacheLookup
    public WebElement miguyouxi;
    //    migu支付
    @FindBy(xpath = "//android.view.View[@content-desc=\"确认支付 Link\"]")
    @CacheLookup
    public WebElement migupay;
...
//    @CacheLookup
    ...
    //    3线 附近模块 附近
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout[4]")
    @CacheLookup
