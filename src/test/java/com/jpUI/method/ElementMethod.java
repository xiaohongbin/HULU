package com.jpUI.method;

import com.aventstack.extentreports.ExtentTest;
import com.jpUI.page.PageElement;
...
//    }
    ...
    public void swipeToUp(AndroidDriver driver) {
        ...
        int width = driver.manage().window().getSize().width;
        int height = driver.manage().window().getSize().height;
        TouchAction action1 = new TouchAction(driver).press(width /3, 1550).waitAction(duration).moveTo(width / 2, 50).release();
        action1.perform();
    }
