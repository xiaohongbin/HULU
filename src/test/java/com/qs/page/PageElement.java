...
/* 公共      //    确认
 ...
 /*公共
    ...
    @CacheLookup
    public WebElement speed_dialog_title;*/
    //头像列表
    @FindBy(id="com.huizheng.lasq:id/iv_speed_item_image")
    @CacheLookup
    public List<WebElement> speed_item_image;
    /* 公共
...
//    性别下拉
    @FindBy(id="com.huizheng.lasq:id/sp_sex")
    @CacheLookup
    public WebElement sp_sex;

    //        女
//    5.6.0 美丽约会 选择性别样式改变
    @FindBy(id = "com.huizheng.lasq:id/btn_women")
//    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.ListView/android.widget.CheckedTextView[2]")
    @CacheLookup
...
//    地址修改
 ...
 /* 公共  //    保存
    ...
    @CacheLookup
    public WebElement num_up_province;
...
//    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout[2]/android.widget.ImageView[1]")
    @CacheLookup
...
//    @FindBy(id = "com.huizheng.lasq:id/video_view")
    ...
    //    空间页 在线状态（美丽约会 UI 下方，id有多个，可使用list，或 xpath）
//    @FindBy(id = "com.huizheng.lasq:id/tv_content")
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.support.v7.widget.RecyclerView/android.widget.RelativeLayout[6]/android.widget.TextView[2]")
    @CacheLookup
...
//    @FindBy(id = "com.huizheng.lasq:id/search_list_item_user_headphoto")
    ...
    //    搜索结果列表中 地区
    @FindBy(id = "com.huizheng.lasq:id/tv_area")
    @CacheLookup
    ...
    //    搜索结果列表中 身高
    @FindBy(id = "com.huizheng.lasq:id/tv_match_info")
    @CacheLookup
...
//    空间页 第二张 被锁照片
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.support.v7.widget.RecyclerView/android.widget.RelativeLayout[3]/android.widget.GridView/android.widget.RelativeLayout[2]/android.widget.ImageView")
    @CacheLookup
...
//    新鲜事
    ...
    //    身边人
//    /hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.HorizontalScrollView/android.widget.LinearLayout/android.widget.FrameLayout[1]/android.widget.TextView
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.HorizontalScrollView/android.widget.LinearLayout/android.widget.FrameLayout[1]/android.widget.TextView")
    @CacheLookup
...
//    牵手 5.6.0 版本 打招呼 id不可通用
//    身边人打招呼
    @FindBy(id="com.huizheng.lasq:id/search_list_item_user_hello")
    @CacheLookup
    public List<WebElement> nearhello;
    //    附近头像
    ...
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.TabHost/android.widget.RelativeLayout/android.support.v4.view.ViewPager/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout[3]/android.widget.ImageView")
...
/*公共
    ...
    //    诚信登记
    @FindBy(id = "com.huizheng.lasq:id/body_item_2_name")
    @CacheLookup
...
//    个性爱好 表头（三线默认已选择，脚本操作会跳过此项）
//                    /hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.TextView[1]
//    @FindBy(xpath="/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.LinearLayout[1]/android.widget.LinearLayout[2]/android.widget.LinearLayout[2]")
    @FindBy(xpath="/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.LinearLayout[2]")
    @CacheLookup
    public WebElement hobbytitle;
...
//    @FindBy(xpath = "//android.widget.Button[@content-desc=\"确认开通并支付\"]")
    ...
    @CacheLookup
    public WebElement alisure;//支付宝付款title,支付宝签约title：支付宝免密支付
*/


    //3线 注册引导 附近title
    @FindBy(xpath="/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.TextView")
    @CacheLookup
    public WebElement yindaoNear;
    //3线 注册引导 LBS引导地图头像
    ...
    @CacheLookup
    public List<WebElement> yindaoTouxiang;
    //  3线  LBS 附近
    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout[1]/android.widget.ImageView")
    @CacheLookup
