...
/*  公共
    ...
    //  注册后录音
    @FindBy(id = "com.huizheng.lasq:id/id_iv_voice_icon")
    @CacheLookup
...
*/
 ...
 /*公共
    ...
    //注册手机号认证弹框-取消
    @FindBy(id = "com.huizheng.lasq:id/btn_pv_dialog_yuanfen_1")
    public WebElement btn_pv_dialog_yuanfen_1;

    //注册手机号认证弹框-马上认证
    @FindBy(id = "com.huizheng.lasq:id/btn_pv_dialog_yuanfen_2")
...
//    个性爱好tab
    ...
    //修改昵称
    @FindBy(id = "com.huizheng.lasq:id/et_input_dialog_content")
    @CacheLookup
    ...
    // 修改详细信息
    @FindBy(id = "com.huizheng.lasq:id/info_content")
...
//    约会吧上方title
    @FindBy(id="com.huizheng.lasq:id/top_bar")
    @CacheLookup
...
//-----------------首页
    //    首页用户主页描述，居住地策略
    @FindBy(id = "com.huizheng.lasq:id/member_monologue")
    public WebElement member_monologue;

    //    首页用户主页描述，居住地
    @FindBy(id = "com.huizheng.lasq:id/member_area")
...
//-------------------消息
    ...
    //    点击右上角的消息按钮
    @FindBy(id = "com.huizheng.lasq:id/top_message_layout")
    @CacheLookup
...
//---------------我的-诚信等级
    ...
    //快捷身份认证-上传头像-选择第一张图片
    @FindBy(id = "com.huizheng.lasq:id/id_item_image")
    public List<WebElement> id_item_image;

    //我的相册
    @FindBy(id = "com.huizheng.lasq:id/body_item_4")
    ...
    //我的相册-添加照片-选择第一张照片
    @FindBy(id = "com.huizheng.lasq:id/id_item_select")
    public List<WebElement> id_item_select;

    //我的相册-添加照片-选择第一张照片-正在上传
    @FindBy(id = "com.huizheng.lasq:id/loading_message")
    ...
    //约会要求-学历
    @FindBy(id = "com.huizheng.lasq:id/myspace_he_education_view")
    ...
    //语音未录制
    @FindBy(id = "com.huizheng.lasq:id/introduce_myself_hint")
    public WebElement introduce_myself_hint;

    //自我介绍-按住语音-提交
    @FindBy(id = "com.huizheng.lasq:id/id_bt_voice_commit")
    ...
    //问答游戏-答题获得缘分-换一题
    @FindBy(id = "com.huizheng.lasq:id/qa_change_question_id")
    @CacheLookup
...
/*公共
//    豆币
    @FindBy(id = "com.huizheng.lasq:id/member_center_bean_layout")
    @CacheLookup
...
//    3天VIP 0元购
   ...
   //    90天会员
    ...
    //    星级服务VIP
    @FindBy(id = "com.huizheng.lasq:id/member_center_vip_layout")
    @CacheLookup
 ...
 //    收信宝-以废掉
   @FindBy(id = "com.huizheng.lasq:id/member_center_receive_letters_layout")
   @CacheLookup
...
//    设置页面
    ...
    //女用户-信箱-缘分小助手-问题类型
    @FindBy(id = "com.huizheng.lasq:id/QA_type_select_tv")
    public WebElement QA_type_select_tv;
    //女用户-信箱-缘分小助手-问题类型列表
    @FindBy(id = "com.huizheng.lasq:id/textview")
        public List<WebElement> QA;
    //女用户-信箱-缘分小助手-问题1
    @FindBy(id = "com.huizheng.lasq:id/QA_content_select_tv")
//    @CacheLookup
...
//    @CacheLookup
    ...
    //男用户登陆后每日推荐-约TA
    @FindBy(id = "com.huizheng.lasq:id/yue_ta_2")
//    @CacheLookup
    public WebElement yue_ta_2;

    //男用户登陆后每日推荐-约TA-右侧用户得昵称
    @FindBy(id = "com.huizheng.lasq:id/right_name")
    //    @CacheLookup
