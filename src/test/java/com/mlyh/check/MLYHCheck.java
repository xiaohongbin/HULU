package com.mlyh.check;

import com.aventstack.extentreports.ExtentTest;
import com.listener.ExtentTestNGITestListener;
import com.listener.WriteUserID;
import com.mlyh.method.ElementMethod;
import io.appium.java_client.android.AndroidDriver;
import org.testng.Assert;

public class MLYHCheck extends ElementMethod {
...
//        this.waitElement(driver, topview);
       ...
       /* if (this.doesWebElementExist(msg_close)) {//等待时间？
        ...
        wui.appendFile("E:\\MLYH.csv",this.getRegisterDate()+","+qudaohao+","+address+","+userid+"\r\n");
        log.pass(userid);
        this.clickBtnLeft();
        this.clickBtnLeft();
...
//        this.judgeVipPrice1(driver,"mlyh");
