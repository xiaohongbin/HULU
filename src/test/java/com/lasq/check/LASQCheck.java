package com.lasq.check;

import com.aventstack.extentreports.ExtentTest;
import com.lasq.method.ElementMethod;
import com.listener.ExtentTestNGITestListener;
import com.listener.WriteUserID;
import io.appium.java_client.android.AndroidDriver;
import org.testng.Assert;

public class LASQCheck extends ElementMethod {
...
//        this.waitElement(driver, topview);
        ...
        wui.appendFile("E:\\LASQ.csv",this.getRegisterDate()+","+qudaohao+","+address+","+userid+"\r\n");
        log.pass(userid);
        this.clickBtnLeft();
        this.clickBtnLeft();
        this.clickYuanFenIcon();
