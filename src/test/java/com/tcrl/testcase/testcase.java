...
//    }
    ...
    public void checkManRegisteNear3() throws Exception {
        TCRLCheck tcrlCheck = PageFactory.initElements(driver, TCRLCheck.class);
        tcrlCheck.registeNear3(driver, qudaohao);
    }
